...
public class GeneticAlgorithmProcessor {
	...
	/**
	 * Constructor
	 * @param creator Individual creator
	 * @param popSize Population size
	 * @param evalFct Evaluation Function
	 * @param mutFct Mutation Function
	 * @param coFct CrossOver Function
	 * @param psMode Parents selection Mode
	 * @param irMode Individual Replacement Mode
	 * @param slMode Stop Limit Mode
	 * @param stopParameter Stop Parameter
	 * @throws GeneticAlgorithmException Exception
	 */
	public GeneticAlgorithmProcessor(IndividualCreator creator, 
									 int popSize,
									 EvaluationFunction<Individual, Void> evalFct, 
									 MutationFunction<Individual, Void> mutFct, 
									 CrossOverFunction<Individual[], Individual> coFct, 
									 ParentsSelectionMode psMode,
									 IndividualReplacementMode irMode,
									 StopLimitMode slMode,
									 int stopParameter) throws GeneticAlgorithmException {
